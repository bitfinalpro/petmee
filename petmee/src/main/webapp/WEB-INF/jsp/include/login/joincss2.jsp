...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/shopping/login/pages.css" />">
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/shopping/login/join.css" />">
...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/shopping/login/magnific-popup2.css" />">
