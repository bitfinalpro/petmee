...
<head>
	...
	<script src="./js/ch-plugin-web.js"></script>
...
<div class="wrapper">
  ...
  <form action="join_end.php" method="post" name="theForm" id="theForm" autocomplete="off">
  ...
  <div class="join_form">
    <ul class="row">
      <li class="col-lg-6">
        <div class="inputbox _btn"><input type="text" name="user_id" id="user_id" maxlength="20" placeholder="아이디">
          <label>아이디<em>(필수)</em></label>
          <a href="javascript:;void(0);" id="id_check" class="btn">중복체크</a>
        </div>
      </li>
      <li class="col-lg-6">
        <div class="inputbox"><input type="text" name="user_name" id="user_name" maxlength="20" placeholder="이름">
          <label>이름<em>(필수)</em></label>
        </div>
      </li>
      <li class="col-lg-6">
        <div class="inputbox"><input type="password" name="userpasswd" maxlength="50" placeholder="비밀번호">
      ...
      <li class="col-lg-6">
        <div class="inputbox"><input type="password" name="userpasswd2" maxlength="50" placeholder="비밀번호 확인">
      ...
      <li class="col-lg-6">
        <div class="inputbox _btn"><input type="text" name="nickname" id="nickname" placeholder="닉네임">
          <label>닉네임<em>(필수)</em></label>            
          <a href="javascript:;void(0);" id="nickname_check" class="btn">중복체크</a>
        </div>
      </li>
      <li class="col-lg-6">
        <div class="inputbox _btn"><input type="text" name="user_email" id="user_email" placeholder="이메일">
      ...
      <li class="col-lg-6">
        <div class="inputbox">
          <div class="row_5">
            <div class="col-lg-3"><input type="text" name="zipcode" id="zipcode" maxlength="5" readonly="readonly" onclick="DaumPostcode();"></div>
            <div class="col-lg-3"><a href="javascript:;void(0);" class="btn" onclick="DaumPostcode();">우편번호</a></div>
            <div class="col-lg-6"><input type="text" name="address1" id="address1" readonly="readonly" maxlength="100" onclick="DaumPostcode();" placeholder="주소"></div>
          </div>
      ...
      <li class="col-lg-6">
        <div class="inputbox">
          <ul class="num">
            <li><input type="text" name="mobile_1" id="mobile_1" maxlength="4"></li>
            <li><input type="text" name="mobile_2" id="mobile_2" maxlength="4"></li>
            <li><input type="text" name="mobile_3" id="mobile_3" maxlength="4"></li>
          </ul>
  ...
  <div class="con-margin-02 text_center posi_r">
    ...
    <!-- <a href="../member/join_03.html" class="btn-type-02">회원가입</a> -->
  </div>
  </form>
</div>
</div>
