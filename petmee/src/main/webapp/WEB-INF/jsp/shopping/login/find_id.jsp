				    ...
				    <div class="pop-box">
				      ...
				      <p class="_mc f_24 memberId"></p>
					     <div class="con-margin-01">
					       ...
					       <a href="javascript:;" class="btn">이메일로 로그인해주세요.
					       	<%-- <c:set var="regDate" value="memberreg" /> --%>
					       	<%-- <c:set target="${board}" property="user" value=".memberreg" /> --%>
					        	<%-- <fmt:formatDate pattern="yyyy-MM-dd" value="${user.memberreg}" /> --%>
					        </a>
					      </div>    
				    </div>
				  </div>
