...
<head>
	...
	<%@ include file="/WEB-INF/jsp/include/login/joincss2.jsp" %>
...
<body cz-shortcut-listen="true">
	...
	<img alt="log" src="http://asp8.http.or.kr/det/datnie.php?cdkey=minipet&amp;idx=af3309c3217cc98c&amp;ssr=33f072a0fd8af41921600e8b730bb881&amp;dat=aW50ZXJuYWwtbmFjbC1wbHVnaW4yQGludGVybmFsLXBkZi12aWV3ZXIxQG1oamZibWRnY2ZqYmJwYWVvam9mb2hvZWZnaWVoamdpMUBAV2luMzJAa28tS1JAQDgyNEAxNTM2QDg2NEAxNTM2" style="width: 1px; height: 1px; display: none;">
	...
	<div class="mdp-bg mdp-ready"></div>
	<div class="mdp-wrap mdp-close-btn-in mdp-auto-cursor mdp-ready" tabindex="-1" style="overflow: hidden auto;">
		<div class="mdp-container mdp-ajax-holder mdp-s-ready">
			<div class="mdp-content">
				<div class="pop-con pop-con-modal">
				  <div class="modal-dialog" style="position: fixed; top: 112px;">
				    <button title="Close (Esc)" onclick="closePopup2();" class="mdp-close"><i class="xi-close-thin"></i></button>
				    <div class="pop-box2">
				      <div class="pop-head _b2">비밀번호 안내</div>
				      <p class="f_18 _b2">회원님의 비밀번호</p>
				      <p class="_mc f_24 memberpas">1231</p>
				      <div class="con-margin-01">
				        <!-- <a href="#" onclick="$.magnificPopup.close();" class="btn">확인</a> -->
				        <a href="javascript:;" class="btn">비밀번호를 확인해주시고 로그인해주세요.</a>
				      </div>      
				    </div>
				  </div>
				</div>
			</div>
			<div class="mdp-preloader">Loading...</div>
		</div>
	</div>
</body>
<script>
function closePopup2(){
	$(".mdp-bg, .mdp-wrap").hide();
}
</script>
</html>