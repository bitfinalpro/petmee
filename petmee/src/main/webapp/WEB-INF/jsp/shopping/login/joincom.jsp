	...
	<script type="text/javascript" language="JavaScript">
		...
		$(document).ready(function(){
			/* $("#email_check").click(function() {								
				...
				if (!idReg.test(theForm.user_email.value)) {
...
<div class="wrapper">
 ...
 <!--      <li class="col-lg-6">
      ...
      <li class="col-lg-6">
        <div class="inputbox _btn">
        <input type="text" name="email" id="user_email" class="user_email" placeholder="이메일" required />
      ...
      <li class="col-lg-6">
        <div class="inputbox">
<!--         <ul class="num"> -->
            <!-- <li> --><input type="text" name="resident" id="resident" maxlength="13"><!-- </li> -->
            <!-- <li><input type="text" name="phone" id="mobile_2" maxlength="7"></li> -->
<!--           </ul> -->
          <label>주민번호<em>(필수)</em>
          	<label style="position:relative; left: 10px; font-weight: 400;">: 숫자 13로 입력해주세요(-없이)</label>
          </label>
        </div>
      </li>
